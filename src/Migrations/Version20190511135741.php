 ...
 */
final class Version20190511135741 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, film_id INT NOT NULL, participant_id INT NOT NULL, regle_id INT NOT NULL, INDEX IDX_7A5BC505567F5183 (film_id), INDEX IDX_7A5BC5059D1C3019 (participant_id), INDEX IDX_7A5BC5058E12947B (regle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
